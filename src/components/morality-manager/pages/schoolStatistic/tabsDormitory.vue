  ...
  <div class="tabs-head">
    ...
    <div class="tabs-outer">
      ...
      <div class="tabs-content" :class="isShow?'h':''">
        <chooseDormitory v-on="$listeners" v-show="ind===0"></chooseDormitory>
...
import chooseDormitory from '@/components/morality-manager/components/chooseDormitory'
...
export default {
  ...
  methods: {
    ...
    //   // console.log(obj)
    //   this.$emit('transDormitoryId', obj)
    // },
    changeInd (index, num) {
      // if (this.isShow) { // 初始化
      //   this.init()
