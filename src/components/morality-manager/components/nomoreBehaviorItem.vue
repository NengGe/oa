      ...
      <div class="record-box">
        <ul class="inner-record">
          <li class="record-item" 
            ...
            <div class="object-p">
              <span class="left">对象: {{item.user_name || item.dorm_name}}</span>
...
import appBtn from '@/components/morality-manager/components/appBtn'
export default {
  name: 'behaviorItem',
  components: {
    appBtn
  ...
  methods: {
    toAppdetails (index, item) {
      // console.log(index)
      this.$emit('toAppDetails', item)
      // this.$router.push({path: 'schoolEntryDetails'})
    }
  },
  created () {
  },
