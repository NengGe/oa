<template>
  <transition name="slide-bottom" enter-active-class="transition-active" leave-active-class="transition-active">
    <div class="select-student page-fixed" v-show="isShow">
      ...
      <listStudent v-show="currIndex===0" ref="listStudent" :classId='classInfo.class_id'></listStudent>
      <listStudentSite v-show="currIndex===1" ref="listStudentSite" :classId='classInfo.class_id'></listStudentSite>
      <listStudentRange v-show="currIndex===2" ref="listStudentRange" :classId='classInfo.class_id'></listStudentRange>
