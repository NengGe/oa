    ...
    <LoaderRefresh @loadData="loadData">
      <div class="record-box">
        <ul class="inner-record">
          ...
          :key="index"
          @click="$router.push({path: 'classDetailPage/2', query: {class_id: item.class_id,event_id: item.event_id}})" 
          >
            <div class="class-p">
...
<script>
import appBtn from '@/components/classManager/components/appBtn'
