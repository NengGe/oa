...
<script>
  ...
  export default {
    ...
    mounted () {
      // this.initDragContainterMinHeight()
    },
    methods: {
      initDragContainterMinHeight () {
        this.$nextTick(() => {
          // let dragElemPNode = dragElem.parentNode
          // this.minHeight = window.innerHeight - (document.body.clientHeight - dragElem.clientHeight)
        })
      },
      reload (complete) {
